...
android {
  namespace = "seanowenhayes.TelloVR"
  compileSdk = 34

  defaultConfig {
    applicationId = "seanowenhayes.TelloVR"
    minSdk = 28
...
spatial {
  ...
  scenes {
    ...
    hotReload {
      appPackage.set("com.meta.spatial.samples.spatialvideosample")
      appMainActivity.set(".SpatialVideoSampleActivity")
